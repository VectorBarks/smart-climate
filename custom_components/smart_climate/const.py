...
CONF_LEARNING_PROBE_STEP = "learning_probe_step"
...
DEFAULT_LEARNING_PROBE_STEP = 1.0
...
DEFAULT_WEATHER_ENTITY_ID = "weather.home"
DEFAULT_OUTDOOR_TEMPERATURE = 22.0
DEFAULT_CURRENT_TEMPERATURE = 22.0
DEFAULT_COMFORT_WINDOW = (20.0, 26.0)
DEFAULT_EMA_COEFFICIENT = 0.2
DEFAULT_EFFICIENCY_SCORE = 50
...
QUIET_MODE_SUPPORTED_HVAC_MODES = ("cool", "dry", "auto")
