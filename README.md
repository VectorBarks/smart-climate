...
> 🔇 **v1.5.5-beta10 Current**: Quiet Mode dashboard sensors now publish live compressor state, suppression count, and status from configured AC power sensors. [Latest Release](https://github.com/VectorBarks/smart-climate/releases)
