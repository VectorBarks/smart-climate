...
> 🧭 **v1.5.5-beta13 Current**: Diagnostic/debug entities now publish explicit states instead of persistent `unknown`, with detail attributes explaining learning, probing, cycle, weather, and seasonal status. [Latest Release](https://github.com/VectorBarks/smart-climate/releases)
